        ...
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="md:flex items-center">
                ...
                <div class="md:w-1/2 fade-in-up" data-delay="400">
                    <img src="<?php echo e(asset('images/layanan.PNG')); ?>" alt="Layanan Penerbitan"
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-20">
                <div class="flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div class="md:w-1/2 fade-in-up" data-delay="400">
                        <img src="<?php echo e(asset('images/about.PNG')); ?>" alt="Penerbitan Buku"
                            class="rounded-lg mx-auto">
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="flex flex-col md:flex-row-reverse items-center gap-10">
                    ...
                    <div class="md:w-1/2 fade-in-up" data-delay="400">
                        <img src="<?php echo e(asset('images/customer.PNG')); ?>" alt="Pemasaran dan Promosi Buku"
                            class="rounded-lg mx-auto">
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\PenerbitSkt\resources\views/layanan.blade.php ENDPATH**/ ?>