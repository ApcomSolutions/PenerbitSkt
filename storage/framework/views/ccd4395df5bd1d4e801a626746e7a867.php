    ...
    <main class="flex-grow container mx-auto px-6 py-8">
        <div class="mb-8 flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <a href="<?php echo e(route('admin.products.create')); ?>" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(asset('js/admin/product-index.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PenerbitSkt\resources\views/admin/products/index.blade.php ENDPATH**/ ?>