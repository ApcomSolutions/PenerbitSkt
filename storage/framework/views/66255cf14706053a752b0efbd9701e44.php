<?php $__env->startSection('content'); ?>
    ...
    <main class="flex-grow container mx-auto px-6 py-8">
        ...
        <form id="product-form" class="space-y-6" enctype="multipart/form-data">
            <input type="hidden" id="product-id" value="<?php echo e($productId); ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-2 max-h-60 overflow-y-auto">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center">
                                        <input type="checkbox" name="categories[]" id="category_<?php echo e($category->id); ?>" value="<?php echo e($category->id); ?>" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PenerbitSkt\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>