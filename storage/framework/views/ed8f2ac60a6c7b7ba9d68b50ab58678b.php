...
<footer class="bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                <div>
                    <img src="<?php echo e(asset('images/footer.png')); ?>" alt="APCOM Solutions" class="h-16 w-auto">
                </div>
        ...
        <div class="mt-8 pt-8 border-t border-gray-700">
            <p class="text-center text-gray-400">
                &copy; <?php echo e(date('Y')); ?> APCOM Solutions. All rights reserved.
            </p>
        </div>
    </div>
</footer>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function initializeMap() {
            ...
            script.src = "https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('services.google.maps_api_key')); ?>&callback=initMap";
            script.async = true;
            script.defer = true;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\PenerbitSkt\resources\views/components/footer.blade.php ENDPATH**/ ?>